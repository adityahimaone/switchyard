...
export function TaskList({ tasks, title = "Context activity", defaultOpen = true, complete = false, leading }: { tasks: TaskListTask[]; title?: string; defaultOpen?: boolean; complete?: boolean; leading?: ReactNode }) {
  ...
  return <div className={styles.todo}>
    ...
    <div className={`${styles.todoCollapsible}${collapsed ? ` ${styles.isCollapsed}` : ""}`}><div className={styles.todoInner}>{leading}<ul className={styles.todoList}>{tasks.length ? tasks.map((task, index) => {
